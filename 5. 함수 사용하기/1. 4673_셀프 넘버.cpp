...
#include<iostream>
#include<ios>
#define N 10001	// 배열 1~10000이므로 10001

using namespace std;
bool arr[N];	// false로 초기화

int selfNumber(int num) {
	int sum = num;	// 자기 자신 더하기

	while (1) {	// 각 자리수의 숫자 더하기
		if (num == 0) break;
		sum += num % 10;	// 1의 자리 더하기
		num /= 10;	// 한 자리씩 없애기
	}
	// 아니면 string으로 변환해서 각 자리수를 구하는 방법도 있을 듯
